                ...
                <div className="page__body">
                    <div className="max-width-wrap">
                        <section>
                            <div className="layout-cols-2">
                                ...
                                <div className="layout-cols-2__right text-align-left">
                                    <p>
                                        Use h1&#39;s for page titles. All other heading tags are the
                                        same - for more variety, scope the heading style to the
                                        component you&#39;re working on. Don&#39;t rely on tags for
                                        typography.
                                    </p>
                                    <p>
                                        123456789 123456789 123456789 123456789 123456789 123456789
                                        123456789 123456789 Lorem ipsum dolor sit amet, consectetur
                                        adipisicing elit. Maxime, repellat, ad. Autem reiciendis
                                        nobis, aspernatur, quo delectus modi quae vel assumenda
                                        aliquam inventore recusandae iure rerum odio veniam,
                                        consectetur non.
                                    </p>
                                </div>
                            </div>
                        ...
                        <section>
                            <h2>Colors</h2>
                            <p>
                                <span className="bg-blue-dark color-white display-inline-block padding">
                                    blue-dark
                                </span>
                                <span className="pad" />
                                <span className="bg-blue-light color-white display-inline-block padding">
                                    blue-light
                                </span>
                                <div className="pad" />
                                <span className="bg-grey-dark display-inline-block padding">
                                    grey-dark
                                </span>
                                <span className="pad" />
                                <span className="bg-grey-light display-inline-block padding">
                                    grey-light
                                </span>
                            </p>
                        </section>
